...
<ol>
    <li>Просмотр диалога
        <ul>
            ...
            <li>маленький баг — при отмотке к началу диалога остаётся надпись «Начните диалог»</li>
            <li>маленький баг — при уменьшении масштаба страницы спиннер остаётся и не прогружаются новые сообщения (см. рисунок 1)
            <div style="text-align: center">
                <img src="static/first_png.png" />
                <p align="center"><b>Рисунок 1</b> — Баг с не исчезновением спиннера</p>
            </div>
            </li>
            <li>маленький баг — если число месяца сообщения совпадает с сегодняшним числом в месяце, то будет надпись «Сегодня». Аналогично с «Вчера»</li>
    ...
    <li>Написание сообщения
        <ul>
            ...
            <li>маленький баг — происходит отправление сообщения, состоящего только из символов переноса строки и пробелов (см. рисунок 2)
            <div style="text-align: center">
            ...
            <li>маленький баг - если смайлик лежит на границе разделения сообщений, то он разделяется пополам и превращается в неизвестный текст (см. рисунок 3)
            <div style="text-align: center">
    ...
    <li>Удаление сообщения
        <ul>
            ...
            <li>маленький баг — при удалении всех сообщений в диалоге не появляется надпись «Начните диалог» (см. рисунок 4)
            <div style="text-align: center">
            ...
            <li>при удалении всех сообщений диалога он пропадает из списка диалогов на страницуе диалогов (https://socio-project.ru/messenger)</li>
        </ul>
    </li>
    <li>Изменение сообщения
        <ul>
            ...
            <li>маленький баг — не изменяя сообщение и принимая изменение, внизу оригинального сообщения появляется текст «ред.»</li>
            ...
            <li>маленький баг — при повторном нажатии дублируется значок скрепки слева от инпута (см. рисунок 5)
            <div style="text-align: center">
...
<ol>
    <li>Создание сообщества
        <ul>
            ...
            <li>маленький баг — при вводе имени группы с цифрами возникает ошибка (см. рисунок 6)
            <div style="text-align: center">
...
<ol>
    ...
    <li>Создание модераторов
        <ul>
            ...
            <li>маленький баг — при вводе ID уже существующего модератора возникает ошибка (см. рисунок 7)
            <div style="text-align: center">
