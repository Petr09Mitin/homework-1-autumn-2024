...
* Если нажать "Выйти", появится модальное окно, в нем нельзя взаимодействовать с частью сайта, которая находится под ним. Если нажать "Нет", то модальное окно скроется и ничего не произойдет. Если нажать "Да", то пользователя разлогинит и произойдет переход на страницу авторизации
...
* В качестве аватара можно загрузить только фото формата jpg и jpeg, webp, gif и png, другие вставить не получается
* Если попытаться загрузить картинку размером >5Мб, то появится ошибка "Максимальный размер файла 5Мб"
